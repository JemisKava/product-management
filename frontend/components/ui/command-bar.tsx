    ...
    >
      ...
      <Popover.Portal>
        <Popover.Content
          ...
          className={cn(
            "hidden md:block z-[9999] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2"
          )}
        >
          {children}
        </Popover.Content>
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "text-sm font-medium text-foreground px-3 py-2.5",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "bg-background border shadow-lg relative flex items-center overflow-hidden rounded-full px-1",
        className
      )}
      {...props}
    />
  ...
  (
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "bg-background text-sm font-medium text-foreground flex items-center gap-x-2 px-3 py-2.5 outline-none rounded-full transition-colors",
